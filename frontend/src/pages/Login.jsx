...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#F5F6F4] dark:bg-[#15191C] px-4">
            ...
            >
                <h1 className="text-2xl font-semibold text-[#1C2321] dark:text-[#E7E9E4] mb-6">Log in</h1>
                ...
                <p className="text-sm text-[#5C645F] dark:text-[#9AA39D] mt-4 text-center">
                    No account? <Link to="/register" className="text-[#2F6F5E] font-medium">Register</Link>
                </p>
            </form>
        </div>
    )
